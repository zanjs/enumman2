...
const enumTemplateStr = `// Code generated by enumman. DO NOT EDIT.
package {{.Package}}
...
{{range $index, $element := .Values}}	{{valueName $element}}:	{{inc .Keys[$index]}}, 
{{end}}}

{{$reverseOrdinalMap := concat $nameLower "Reverse" "Ordinal" "Map"}}
// Reverse ordinal lookup
var {{$reverseOrdinalMap}} = map[int]{{$type}}{
{{range $index, $element := .Values}}	{{inc .Keys[$index]}}:	{{valueName $element}}, 
{{end}}}
...
var (
	output      = flag.String("output", "./%s_enumman.go", "output file path")
	...
	keys        = flag.String("keys", "", "keys comma keys index")
